...
```{r}
xf_test <- sagemaker$transformer$Transformer$attach(
  "xgboost-191110-1612-007-23030f47-2019-11-12-02-37-08-525"
)
```
...
download_file(
  ...
  "abalone-transform.csv/abalone-inference.csv.out"
)
```

```{r}
library(readr)
pred <- read_csv("test-inference.csv", col_names = FALSE)
pred
```
